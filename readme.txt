To Use Our Magic City Travels Web App, please:
...
5. Run the web server via the main.py file (type in command prompt "python main.py"
6. Open Browser and Navigate to specified IP address by webserver (default "http://127.0.0.1:5000")
7. Enjoy!
